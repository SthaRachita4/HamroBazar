...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.user_dispalyed_layout,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide.with(context).load(user.getProfilepictureuri()).into(holder.userProfileImage);
    ...
    public ViewHolder(@NonNull View itemView) {
        ...
        bloodGroup =itemView.findViewById(R.id.userName);
